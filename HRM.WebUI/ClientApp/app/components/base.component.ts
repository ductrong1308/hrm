...
import { AppUtil, QueryState } from '../services/app.util';
...
export class HrmBaseFormComponent extends BaseComponent implements OnInit {
    ngOnInit() {}
}

export class HrmBaseListComponent extends BaseComponent implements OnInit {
